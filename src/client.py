...
class Client:
    ...
    def work(self,device_id,elimit,train_round):
        ''' 
        ...
        for i in range(elimit):
            ...
            update,accuracy,cmp_time = client.update_model(model, train_round)  # 训练轮数
...
if __name__ == '__main__':
    ...
    parser.add_argument('-tr', '--train_round', default=10, type=int, help='Number of epochs')
